...
//            0xB7, 1, 0x06,      //Entry Mode Set [06]
    ...
    case 0x9340:
        _lcd_capable = AUTO_READINC | MIPI_DCS_REV1 | MV_AXIS | READ_24BITS;
        static const uint8_t ILI9340_regValues_ada[] PROGMEM = {
            ...
            0xB6, 3, 0x08, 0x82, 0x27, // Display Function Control [0A 82 27 XX]
            0xF2, 1, 0x00,      //Enable 3G [02]
            0x26, 1, 0x01,      //Gamma Set [01]
            0xE0, 15, 0x0F, 0x31, 0x2B, 0x0C, 0x0E, 0x08, 0x4E, 0xF1, 0x37, 0x07, 0x10, 0x03, 0x0E, 0x09, 0x00,
            0xE1, 15, 0x00, 0x0E, 0x14, 0x03, 0x11, 0x07, 0x31, 0xC1, 0x48, 0x08, 0x0F, 0x0C, 0x31, 0x36, 0x0F,
        };
        static const uint8_t ILI9340_5[] PROGMEM = { //
        ...
        static const uint8_t ILI9340_6[] PROGMEM = { //
...
//            0xB6, 2, 0x0A, 0xA2, 0x27, //Display Function [0A 82 27 XX]    .kbv SS=1 
        ...
        static const uint8_t ILI9341_LG2_6_Initial[] PROGMEM = {
...
//            (0xC7), 1, /*VCM control2*/ 0xC0, 
        ...
        static const uint8_t ILI9341_BOE2_0_Initial[] PROGMEM = {
        ...
        static const uint8_t ILI9341_BOE2_4_Initial[] PROGMEM = {
        ...
        static const uint8_t ILI9341_Tianma2_4_Initial[] PROGMEM = {
            (0xCF), 3, 0x00,0x81,0x30,
            (0xED), 4, 0x64,0x03,0x12,0x81,
...
//        table8_ads = ILI9341_LG2_6_Initial, table_size = sizeof(ILI9341_LG2_6_Initial);   //
//        table8_ads = ILI9341_BOE2_0_Initial, table_size = sizeof(ILI9341_BOE2_0_Initial);   //
//        table8_ads = ILI9341_BOE2_4_Initial, table_size = sizeof(ILI9341_BOE2_4_Initial);   //
//        table8_ads = ILI9341_Tianma2_4_Initial, table_size = sizeof(ILI9341_Tianma2_4_Initial);   //

//        table8_ads = ILI9340_5, table_size = sizeof(ILI9340_5);   //
//        table8_ads = ILI9340_6, table_size = sizeof(ILI9340_6);   //
        table8_ads = ILI9340_regValues_ada, table_size = sizeof(ILI9340_regValues_ada);   //
        break;
	case 0x9341:
        _lcd_capable = AUTO_READINC | MIPI_DCS_REV1 | MV_AXIS | READ_24BITS;
